...
Check select one game
    ...
    Click Game Comparison Across Partner in submenu
    Sleep    1
    Click element    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/div/div/div
    Click Element    xpath=html/body/div[2]/div/div/div/ul/li[1]
    Sleep    1
    Double Click Element    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[3]
    Sleep    1
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/div/div/div    Bloodlines
...
Check select All games
    ...
    Click Game Comparison Across Partner in submenu
    Sleep    1
    Select checkbox    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/label/span[1]/input
	Sleep    1
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/div/div/div    Bloodlines
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/div/div/div    Machine Gun Unicorn
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/div/div/div    Mirror Magic
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/div/div/div    Hear Me Roar
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/div/div/div    Fruity Grooves
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/div/div/div    Sea Raider
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/div/div/div    Beir Fest
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/div/div/div    Bark In The Park
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/div/div/div    Rumpelthrillspins
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/div/div/div    BL_M4_V2_RECORDER
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/div/div/div    M4-0041;V:1
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[1]/div/div/div[2]/div/div/div/div    Journey To The West
...
Check select one Parnter
    ...
    Click Game Comparison Across Partner in submenu
    Sleep    1
    Click element    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[2]/div/div/div[2]/div/div/div/div
    Click Element    xpath=html/body/div[2]/div/div/div/ul/li[1]
    Sleep    1
    Double Click Element    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[1]
    Sleep    1
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[2]/div/div/div[2]/div/div/div/div    BBIN Staging
...
Check select All Parnters
    ...
    Click Game Comparison Across Partner in submenu
    Sleep    1
    Select checkbox    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[2]/div/div/div[2]/div/label/span[1]/input
    Sleep    1
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[2]/div/div/div[2]/div/div/div/div    BBIN Staging
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[2]/div/div/div[2]/div/div/div/div    GPK Staging
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[2]/div/div/div[2]/div/div/div/div    GT Staging test
    Element Should Contain    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[2]/div/div/div[2]/div/div/div/div    GT Staging
...
Download File checking-Partner_Selected
    ...
    Click Element    xpath=html/body/div[2]/div/div/div/ul/li[1]
    Sleep    1
    Double Click Element    xpath=html/body/div[1]/div/div/section/div
    Sleep    1
    Click Search button
    Sleep    2
    Click Export button
...
Download File checking-Game_Selected
    ...
    Double Click Element    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[4]/div
    Sleep    1
    Select checkbox    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[3]/div[2]/div/div/div[2]/div/label/span[1]/input
    Sleep    1
    Click Search button
