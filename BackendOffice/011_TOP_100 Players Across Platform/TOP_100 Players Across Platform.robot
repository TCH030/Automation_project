...
Switch Report Currency Type
    ...
    Click TOP 100 Players Across Platform in submenu
    Sleep    1
    Click Element    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[5]/div/div[2]/div/div[2]/div/div/div/div
    Wait Until element is Visible    xpath=html/body/div[2]/div/div/div/ul/li[2]    2
    Click Element    xpath=html/body/div[2]/div/div/div/ul/li[2]
    ${filter_Wallet_Transaction}    get text    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[5]/div/div[2]/div/div[2]/div/div/div/div
...
Query a report with Partner selected
    ...
    Click TOP 100 Players Across Platform in submenu
    Sleep    1
    Click Element    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[5]/div/div[1]/div/div[2]/div/div/div/div
    Sleep    1
    Click Element    xpath=html/body/div[2]/div/div/div/ul/li[2]
    Sleep    1
    CLick Element    xpath=html/body/div[1]/div/div/section/div/div[1]/div/form/div[1]
